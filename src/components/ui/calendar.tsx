...
function Calendar({
	...
	return (
		<DayPicker
			...
			className={cn(
				'group/calendar rounded-xl bg-gray-700 p-2 text-gray-100 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(7)]',
			...
			classNames={{
				...
				day: cn(
					'group/day relative aspect-square border border-transparent h-full w-full rounded-(--cell-radius) p-0 text-center select-none  data-[selected=true]:bg-gray-800 [&:last-child[data-selected=true]_button]:rounded-r-(--cell-radius)',
				...
				range_start: cn(
					'relative isolate z-0 rounded-l-(--cell-radius) bg-gray-800 after:absolute after:inset-y-0 after:right-0 after:w-4 after:bg-gray-800',
					defaultClassNames.range_start,
				),
				range_middle: cn('rounded-none', defaultClassNames.range_middle),
				range_end: cn(
					'relative isolate z-0 rounded-r-(--cell-radius) bg-gray-800 after:absolute after:inset-y-0 after:left-0 after:w-4 after:bg-gray-800',
					defaultClassNames.range_end,
				),
				today: cn('rounded-lg !border-gray-600', defaultClassNames.today),
