...
const StreamlineMailSendEnvelopeIcon = (props: Omit<SvgProps, 'xml'>) => {
	const xml = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M12.5 1.75h-11a1 1 0 0 0-1 1v8.5a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-8.5a1 1 0 0 0-1-1"/><path d="m.5 3l5.86 3.524c.18.106.406.163.64.163s.46-.057.64-.163L13.5 3"/></g></svg>`

	return <SvgXml xml={xml} {...props} />
}

export default StreamlineMailSendEnvelopeIcon
