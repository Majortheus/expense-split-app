...
export function ActivityDetailsHeader({ title, date, onBackPress, onEditPress }: ActivityDetailsHeaderProps) {
	return (
		<View className="relative w-full">
			<View className="flex-row items-start justify-between gap-4">
				...
				<Pressable onPress={onEditPress} className="absolute right-0 top-0 h-12 w-12 items-center justify-center rounded-full border border-gray-500 bg-gray-600">
